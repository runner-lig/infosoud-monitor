...
SOUDY_MAPA = {
    ...
    "OSST": "Okresní soud ve Strakonicích", "OSTA": "Okresní soud v Táboře", "KSZPCPM": "Krajský soud Plzeň",
    "KSPLKV": "KS Plzeň - pobočka Karlovy Vary", "OSZPCDO": "Okresní soud v Domažlicích", "OSCH": "Okresní soud v Chebu",
    "OSKV": "Okresní soud v Karlových Varech", "OSZPCKV": "Okresní soud v Klatovech", "OSZPCPM": "Okresní soud Plzeň-město",
    "OSPJ": "Okresní soud Plzeň-jih", "OSZPCPS": "Okresní soud Plzeň-sever", "OSRO": "Okresní soud v Rokycanech",
    ...
    "OSSCECV": "Okresní soud v Chomutově", "OSJN": "Okresní soud v Jablonci nad Nisou", "OSLI": "Okresní soud v Liberci",
    "OSLT": "Okresní soud v Litoměřicích", "OSLN": "Okresní soud v Lounech", "OSSCEMO": "Okresní soud v Mostě",
    "OSSCETP": "Okresní soud v Teplicích", "OSUL": "Okresní soud v Ústí nad Labem", "KSVYCHK": "Krajský soud v Hradci Králové",
    ...
    "OSUH": "Okresní soud v Uherském Hradišti", "OSJIMVY": "Okresní soud ve Vyškově", "OSZL": "Okresní soud ve Zlíně",
